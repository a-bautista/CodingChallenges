...
class PS5Bot:
    ...
    def __init__(self, first_name, last_name, email, address, phone, credit_number,
                 credit_month, credit_year, credit_ccv):
        ...
        self.driver = webdriver.Chrome("C:\\Users\\alexb\\PycharmProjects\\AmazonOA\\chromedriver.exe")
        #self.driver.get('https://www.walmart.com/ip/PlayStation-5-Console/363472942')
        self.driver.get('https://www.walmart.com/ip/Mainstays-Wood-14-Jumbo-Head-Spoon/45081846')
...
if __name__ == "__main__":
    personal_info = dict(
        ...
        last_name="Bautista Ramos",
        email="almrow@gmail.com",
        address="5716 Owens Dr Apt 302 Pleasanton, CA",
        phone="3072599617",
        credit_number="5290289950347747",
        credit_month="01",
        credit_year="21",
        credit_ccv="439"
        #chrome_path="C:\\Users\\alexb\\PycharmProjects\\AmazonOA\\chromedriver_win32.exe"
    )
